                    ...
                    <?php
                        ...
                        if (isset($_GET['q'])) {
                            ...
                            $sql = "SELECT sanpham.*, danhmucsanpham.TEN_DM 
                                    ...
                                    WHERE (sanpham.TEN_SP LIKE '%$search_query%' OR danhmucsanpham.TEN_DM LIKE '%$search_query%') AND sanpham.ID_DM = 102";
                        } else {
                            // Default query without search and filter by ID_DM
                            $sql = "SELECT sanpham.*, danhmucsanpham.TEN_DM FROM sanpham INNER JOIN danhmucsanpham ON sanpham.ID_DM = danhmucsanpham.ID_DM WHERE sanpham.ID_DM = 102";
                        }
