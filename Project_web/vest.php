            ...
            <div class="grid-column-2-5">
                    <ul class="portfolio">
                        <h2 class="portfolio__header">
                            <i class="fa-solid fa-bars"></i>product portfolio
                        </h2>
                        <a href="./t-shirt.php" class="portfolio-link">
                            <li class="portfolio-item">T-shirt</li>
                        </a>
                        <a href="./shirt.php" class="portfolio-link">
                            <li class="portfolio-item">Shirt</li>
                        </a>
                        <a href="#" class="portfolio-link">
                            <li class="portfolio-item">Vest</li>
                        </a>
                        <a href="./jeans.php" class="portfolio-link">
                            <li class="portfolio-item">Jeans</li>
                        </a>
                        <a href="./dresspants.php" class="portfolio-link">
                            <li class="portfolio-item">Dress pants</li>
                        </a>
                        <a href="./cargopants.php" class="portfolio-link">
                            <li class="portfolio-item">Cargo pants</li>
                        </a>
                    </ul>
            </div>
            ...
            <div class="grid-column-10">
                    ...
                    <!-- <div class="select-input">
                        ...
                        <ul class="select-input__list">
                            <li class="select-input__item">
                                <a href="" class="select-input__link">price: low to hight</a>
                            </li>
                            <li class="select-input__item">
                                <a href="" class="select-input__link">price: hight to low</a>
                            </li>
                        </ul>   
                    </div> -->
                </div>
                ...
                <div class="home-product">
                    <div class="grid-row">
                        ...
                        $sql = "SELECT sanpham.*, danhmucsanpham.TEN_DM FROM sanpham 
                        INNER JOIN danhmucsanpham ON sanpham.ID_DM = danhmucsanpham.ID_DM
                        WHERE sanpham.ID_DM = 103";
                        ...
                        if ($ketqua->num_rows > 0) {
                            while ($row = $ketqua->fetch_assoc()) {
                                ...
                                echo '<a href="#" class="home-product-item__link">';
                    ...
                    <div class="grid-row">
                        <div class="home-product-item">
                            <a href="" class="home-product-item__link">
                                <img src="./asset/img/clothes/vest.jpg" alt="" class="home-product-item__img">
                                <div class="home-product-text">
                                    <h4 class="home-product-item__name">Vest: </h4><p>Chocolate Pockets Chiffon Vest Tops Back Side Open Solid Color Sleeveless</p>
                                    <div class="home-product__price-cover">
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-old">Was: $1,295.00</span></br>
                                            <span class="home-product-item__price-current">Now: $795.00</span>
                                        </div>
                                        <div class="home-product-item-pay">
